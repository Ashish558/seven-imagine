...
import { useAddUserDetailsMutation, useSignupUserMutation } from "../../app/services/auth";
...
export default function Signup() {
   ...
   const addDetails = () => {
      ...
      addUserDetails({userId: values.userId, body: reqBody})
      .then(res => {
         console.log(res)
         ...
         <div className="grid grid-cols-2 min-h-screen">
            ...
            <div className="flex items-center">
               <div className="w-full px-148 py-8">
                  ...
                  <h1>
                     {frames.signupActive ? "Signup" : frames.setPassword ? '' : "Profile Details"}
                  </h1>
                  ...
                  {frames.signupActive ? (
                     <>
                        ...
                        <div className="flex items-center">
                           <CCheckbox checked={values.checked}
                     ...
                     frames.selectPersona ? (
                        ...
                        <SelectServices {...props} services={services}
                           setServices={setServices} {...otherDetailsProps}
                           {...valueProps} />
                     ) : frames.userDetails ? (
                        <UserDetails {...props} {...otherDetailsProps} />
                     ) : frames.questions ? (
                        <Questions {...props} {...otherDetailsProps}
                           apCourses={apCourses} motive={motive}
                           setApCourses={setApCourses} setMotive={setMotive} />
                     ) : frames.signupLast ? (
                        <SignupLast {...props} hearAboutUs={hearAboutUs} setHearAboutUs={setHearAboutUs} />
                     ) : frames.signupSuccessful ? (
                        <SignupSuccessful {...props} addDetails={addDetails} />
                     ) :
                        (
                           ""
                        )
